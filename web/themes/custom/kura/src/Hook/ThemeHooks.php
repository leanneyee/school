...
use Drupal\kura\RenderCallbacks;
...
/**
 * Contains hook implementations for Kura.
 */
final class ThemeHooks {
  ...
  public function themeSettingsFormAlter(array &$form): void {
    ...
    $message = $this->t("See <code>@path</code> to learn how to customize Kura's fonts, colors, and components.", [
      '@path' => $this->themeList->getPath('kura') . '/CUSTOMIZING.md',
    ]);
  ...
  public function preprocessHtml(array &$variables): void {
    ...
    $variables['kura_path'] = $this->requestStack->getCurrentRequest()->getBasePath() . '/' . $this->themeList->getPath('kura');
  }
